# This code is used to solve stationary equilibrium with diffusion productivity and diffusion capital.
# We can obtain:
# 1. Supply curve and demand curve for capital.
# 2. Equilibrium distribution for capital and productivity.
# 3. Equilibrium saving and consumption with respect to capital and productivity.
# 4. Lorenz curve of income(labor income plus wealth income) and wealth in steady state.
# Note:
# 1. We use Parellel Computing in the solving process of supply curve and demand curve to enhance efficiency.
# 2. See notion for the finer parameter couple for x_size and x_min, x_max. The higher the x_size, the slower the solving process.
import numpy as np
...
class Household(object):
    def __init__(self,
        ...
        # Tax formula and government revenue
        # initial assumption of tax formula
        self.Tax_Rate = 0.01 * np.ones(self.x_size)
